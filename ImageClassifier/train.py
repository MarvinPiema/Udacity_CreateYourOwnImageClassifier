...
model = model_function.build_network(network_architecture, hidden_units)
model.class_to_idx = train_data.class_to_idx

model, criterion = model_function.train_network(model, epochs, learning_rate, trainloader, validloader, gpu)
model_function.evaluate_model(model, testloader, criterion, gpu)
model_function.save_model(model, network_architecture, hidden_units, epochs, learning_rate, save_dir)
